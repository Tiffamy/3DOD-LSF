...
class ProposalTargetLayer(nn.Module):
    ...
    def sample_rois_for_rcnn(self, batch_dict):
        ...
        for index in range(batch_size):
            ...
            # print(sampled_inds.shape) # 128
            # print(batch_rois[index].shape) # 128, 7
            # print(batch_roi_labels[index].shape) # 128
            # print(batch_roi_ious[index].shape) # 128
            # print(batch_roi_scores[index].shape) # 128
            # print(batch_gt_of_rois[index].shape) # 128, 8
